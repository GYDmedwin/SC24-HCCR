...
struct page_xfer {
	...
	int (*write_pages)(struct page_xfer *self, int pipe_read, int pipe_write, unsigned long len);
...
extern void initThpool(void);
extern void syncThpool(void);
extern void destoryThpool(void);
